...
public class custom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offsetAndRotation(1.675F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r6 = frontBananaPeel.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(2, 12).addBox(2.0489F, -0.3539F, -1.0F, 0.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
